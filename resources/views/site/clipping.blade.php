                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="vc_tta-tabs-container">
                                                                        <ul class="vc_tta-tabs-list">
                                                                            @foreach ($item->clippings as $clippingAccordion)
                                                                                <li class="vc_tta-tab @if ($clippingAccordion['id'] == $item->clippings[0]['id']) vc_active @endif"
                                                                                    data-vc-tab=""><a
                                                                    ...
                                                                    <div class="vc_tta-panels-container">
                                                                        @foreach ($item->clippings as $clippingAccordion)
                                                                            <div class="vc_tta-panels">
                                                                                <div class="vc_tta-panel @if ($clippingAccordion['id'] == $item->clippings[0]['id']) vc_active @endif"
                        ...
                        <div class="accordion-item">
                            ...
                            <h2 class="accordion-header" id="heading{{ $clippingAccordion['id'] }}">
                                ...
                                <button class="accordion-button collapsed shadow-none" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapse{{ $clippingAccordion['id'] }}"
                                    aria-expanded="false" aria-controls="collapse{{ $clippingAccordion['id'] }}">
                            ...
                            <div id="collapse{{ $clippingAccordion['id'] }}"
                                class="accordion-collapse collapse @if ($clippingAccordion['id'] == $item->clippings[0]['id']) show @endif"
