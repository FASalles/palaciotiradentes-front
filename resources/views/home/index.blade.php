        ...
        <div class="container">
            <div class="row mb-2">
                <div class="col-md-6">
                    ...
                    <div class="vc-separator "><span class="vc_sep_holder"><span class="vc_sep_line"></span></span>
                    </div>

                    <div class="row mt-4 g-0 border-bottom overflow-hidden flex-md-row mb-2 h-md-250 position-relative">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row mt-5 g-0  overflow-hidden flex-md-row mb-4  h-md-250 position-relative">
