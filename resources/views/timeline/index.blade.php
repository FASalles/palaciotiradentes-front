                    ...
                    <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                        <ul class="trail-items" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                            <li class="trail-item trail-begin">
                                <a href="//palaciotiradentes.rj.gov.br" rel="home">
                                    <span>Home</span>
                                </a>
                                ...
                                <dl>
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>Muito antes da construção&nbsp;do Palácio Tiradentes,&nbsp;o local onde hoje está a sede&nbsp;do Poder Legislativo do Estado&nbsp;do Rio de Janeiro abrigava&nbsp;um edifício conhecido como&nbsp;CASA DE CÂMARA E CADEIA.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </dd>
                                    ...
                                    <dd id="3" class="pos-right clearfix even full">
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>Tiradentes fica preso durante três anos na Cadeia Velha antes se ser levado à forca na manhã de sábado, 21 de abril. Ele caminhou em procissão até a Praça da Lampadosa (atual Tiradentes), onde foi morto. A leitura da sentença estendeu-se por dezoito horas, após a qual houve discursos de aclamação à rainha.
                                                        &nbsp;
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <dd id="1" class="pos-right clearfix even full">
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>Com a saída de Vargas, em 1945, o Palácio Tiradentes novamente pôde abrigar uma Assembleia Constituinte, que permitiria ao Brasil construir uma NOVA FASE POLÍTICA, com a formação de partidos políticos e a estruturação de instituições democráticas.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </dd>
                                    <dd id="2" class="pos-left clearfix odd full">
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>Sob o argumento de que era preciso desenvolver o interior do País, Juscelino Kubitscheck transfere a capital para Brasília e o Palácio Tiradentes passa a abrigar a Assembleia Legislativa do Estado da Guanabara.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </dd>
                                    ...
                                    <dd id="1" class="pos-left clearfix odd full">
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>O Parlamento do Brasil permaneceu no Palácio Tiradentes até 1960, quando a capital do país foi transferida para Brasília. Com isso, o Palácio se tornou a sede da ASSEMBLEIA LEGISLATIVA DO ESTADO DA GUANABARA (ALEG) e, no ano de 1975, com a fusão dos estados da Guanabara e do Rio de Janeiro, passou a abrigar a Assembleia Legislativa do Estado do Rio de Janeiro (Alerj), onde funciona até hoje.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </dd>
                                    <dd id="2" class="pos-right clearfix even full">
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>É feita a primeira grande restauração do Palácio Tiradentes e inaugurada a Exposição Permanente: Palácio Tiradentes, lugar de memória do parlamento Brasileiro. Inicia-se, nesta fase, um processo de maior abertura das portas do Palácio para a sociedade que perdura até os dias atuais. A Cultura passa a ocupar mais espaço, com encenação de peças nas escadarias, concertos e exposições gratuitas. É criado o número 0800 do Alô, Alerj!; vantagens e super salários de servidores são cortados e o site da casa vira uma agênbcia de notícias.
                                                        O Parlamento fluminense passa a ser destacar como de vanguarda: é o primeiro do Brasil a aprovar leis como o passe livre para estudantes (1999); fim do voto secreto (2001); cotas raciais em universidades públicas (2003), proibição de contratação de parentes nos três poderes (2005) e cria um aplicativo de celular (Carteirada do Bem) onde o cidadão pode conhecer leis que fazem parte do seu dia a dia e cobrar seu direito (2015).
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <dd id="3" class="pos-left clearfix odd full">
                                        ...
                                        <div class="events">
                                            ...
                                            <div class="ctl_info event-description full">
                                                <div class="events-body">
                                                    <p>Nos 90 anos do Palácio, a Alerj promove, com recursos economizados durante quatro anos do seu orçamento, a segunda grande reforma externa do prédio, castigado pelo tempo e por depredações. A intenção é fazer do Palácio um Museu Vivo, onde a história acontece todos os dias.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </dd>
