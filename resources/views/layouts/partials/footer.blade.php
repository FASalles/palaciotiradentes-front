        ...
        <div class="container ">
            ...
            <section class="">
                ...
                <div class="row">
                    ...
                    <ul id="footer-menu" class="menu-footer mt-3 mb-5"><li id="menu-item-38" class="facebook menu-item menu-item-type-custom menu-item-object-custom menu-item-38"><a target="_blank" href="https://www.facebook.com/assembleiaRJ">Facebook</a></li>
