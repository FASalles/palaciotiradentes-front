    ...
    <div class="container mt-5">
        ...
        <form action="{{route('create.store')}}" method="post" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="form-floating mb-3 col-md-5">
                <input type="text" class="form-control @error('fullName') is-invalid @enderror" name="fullName" id="fullName" value="{{ old('fullName') }}" placeholder="Name">
                <label for="fullName">
                    <i class="fa-solid fa-user-tie fa-lg" style="margin-right: 20px;"></i> Nome Completo *
                </label>
                @error('fullName')
                <div class="invalid-feedback">
