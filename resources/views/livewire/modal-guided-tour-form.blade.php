                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-floating col-md-12 mb-3">
                                ...
                                <label for="form.fullNameGuest" style="margin-left: 10px;"> <i class="fa-solid fa-user fa-lg" style="margin-right: 20px; margin-left: 10px;"></i> Nome Completo *</label>
{{--                                @error('form.fullNameGuest')--}}
...
{{--                                @enderror--}}
                            ...
                            <div class="form-floating col-md-6 mb-3">
                                <input type="date" class="form-control" wire:model.defer='form.birthDateGuest' id="form.birthDateGuest" name="form.birthDateGuest" placeholder="form.birthDateGuest" required>
                                <label for="form.birthDateGuest" style="margin-left: 10px;">Data de Nascimento *</label>
{{--                                @error('form.birthDateGuest')--}}
{{--                                <span class="text-danger">{{ $message }}</span>--}}
{{--                                @enderror--}}
                            </div>

                            <div class="form-floating col-md-6 mb-3">
                                <select class="form-select" name="genderIdentityGuest" id="genderIdentityGuest" required>
...
{{--                                @enderror--}}
                            ...
                            <div class="form-floating col-md-6 mb-3">
                                <select class="form-select @error('disability') is-invalid @enderror" name="disability" id="disability" x-ref="disability" wire:model.debounce.500ms="disability" required>
                                    <option value="">selecione uma opção</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <label for="option1" class="form-check-label">
                                            <input type="checkbox" id="option1" name="tipeOfDisability[]" value="Opção 1" class="form-check-input" checked> Física
                                        </label>
                                    </div>
                                    <div class="form-group">
